...
public class DescendingSortAction extends LocalizableAction{
	...
	/**	SerialVersionUID. */
	private static final long serialVersionUID = -3110270453683802770L;
	/**	TabbedPane containing all opened files. */
	private JTabbedPane tabbedPane;
	
	/**
	 * Creates a new {@link DescendingSortAction}.
	 ...
	 */
	public DescendingSortAction(JNotepadPP jNotepadPP, JTabbedPane tabbedPane, FormLocalizationProvider flp) {
		super("descending", "descendingDescription", flp);
