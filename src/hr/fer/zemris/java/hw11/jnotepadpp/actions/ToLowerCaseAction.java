...
/**
 * Action which occurs when inverting text to lower case.
...
public class ToLowerCaseAction extends LocalizableAction{
	...
	/**	SerialVersionUID. */
	private static final long serialVersionUID = -7398806397992488307L;
	/**	TabbedPane containing all opened files. */
	private JTabbedPane tabbedPane;
	
	/**
	 * Creates a new {@link ToLowerCaseAction}.
	 ...
	 */
	public ToLowerCaseAction(JNotepadPP jNotepadPP, JTabbedPane tabbedPane, FormLocalizationProvider flp) {
		super("toLower", "toLowerDescription", flp);
